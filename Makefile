...
hadoop.root=/usr/local/hadoop-3.3.6
app.name=SparkShortestPath
# app.name=refac
jar.name=spark-demo.jar
maven.jar.name=spark-demo-1.0.jar
job.name=path.SparkShortestPath
# job.name=path.refac
local.master=local[4]
# local.input=input
# local.input=../Friendster/data/com-friendster.ungraph.txt
local.input=input
local.output=outputTry
local.log=log
...
aws.bucket.name=sparksfriendstercomplete
aws.input=input/com-friendster.ungraph.txt
# aws.input=../Friendster/data/com-friendster.ungraph.txt
aws.output=output
aws.log.dir=log
aws.num.nodes=8
aws.instance.type=m7a.xlarge
# -----------------------------------------------------------
...
aws: jar upload-app-aws delete-output-aws
	aws emr create-cluster \
		--name "SparkShortestPathFriendster 8 nodes 100 part" \
